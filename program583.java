...
class Matrix
{
    ...
    public int DiagonalSum()
    {
        ...
        if(iRow != iCol)
        {
            ...
            System.out.println("Bacause matrix is not a square natrix");
    ...
    public void SumEvenOdd()
    {
        ...
        System.out.println("Addition is even elements : "+iSumEven);
        System.out.println("Addition is odd elements : "+iSumOdd);
    }
    ...
    public void AdditionDigits()
    {
        ...
        System.out.println("Addition of digit is :");
        for(i = 0; i < iRow; i++)
        {
            for(j = 0; j < iCol; j++)
            {
